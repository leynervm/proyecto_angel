    ...
    <div x-cloak x-data="sidebar()" class="relative flex items-start w-full max-w-full">
        <div class="flex flex-col h-screen bg-blue-50" :class="{ 'w-56': sidebarOpen, 'w-14': !sidebarOpen }">
            <div :class="{ 'justify-between': sidebarOpen, 'justify-center': !sidebarOpen }"
                class="w-full flex items-center bg-principal top-0 z-40 transition-all duration-300">
                <button @click="sidebarOpen = !sidebarOpen; setSidebar()"
                    class="text-white transition-all duration-300 p-3 rounded-full focus:outline-none">
                ...
                <div :class="{ 'flex': sidebarOpen, 'hidden': !sidebarOpen }"
                    class="flex-1 bg-principal items-center justify-center p-3 text-center duration-300">
                    <a href="#" class="text-lg leading-normal text-secondary focus:outline-none focus:ring">
                        Publicalín</a>
                </div>
            </div>
                ...
                <ul class="flex-grow md:block md:overflow-y-auto overflow-x-hidden">
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="item-link-sidebar {{ request()->routeIs('admin.orders') ? 'item-sidebar-active' : '' }}"
                                    ...
                                    <span class="mx-4"
                                        :class="{ 'block': sidebarOpen, 'hidden': !sidebarOpen }">GENERAR
                                        PEDIDO</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a class="item-link-sidebar {{ request()->routeIs('admin.estados') ? 'item-sidebar-active' : '' }}"
                            ...
                            <span class="mx-4" :class="{ 'block': sidebarOpen, 'hidden': !sidebarOpen }">ESTADOS DE
                                SEGUIMIENTO</span>
                        </a>
                    </li>
                </ul>
        ...
        <div class="w-full flex-1 flex-col p-1 lg:p-3 transition-all duration-300 md:flex md:flex-col min-h-screen">
            {{ $slot }}
